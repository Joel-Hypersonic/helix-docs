...
---@param Location FVector World position (default: 0,0,0)
---@param Rotation FRotator World orientation (default: 0,0,0)
---@param Color FLinearColor Light color and opacity (default: white opaque)
---@param LightTypeParam string One of LightType.Spot, .Point, .Rect (default: Point)
